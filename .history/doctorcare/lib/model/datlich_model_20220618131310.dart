...
class DatLichModel {
  ...
  factory DatLichModel.fromMap(Map<String, dynamic> map) {
    return DatLichModel(
      uidBacSi: map['uidBacSi'] != null ? map['uidBacSi'] as String : null,
      uidNguoiKham: map['uidNguoiKham'] != null ? map['uidNguoiKham'] as String : null,
      tenNguoiKham: map['tenNguoiKham'] != null ? map['tenNguoiKham'] as String : null,
