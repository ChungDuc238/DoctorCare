                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: const Text(
                                    ' Minh chứng về việc mình là bác sĩ:',
                                    style: TextStyle(fontSize: 21)),
                              ),
                              SizedBox(
                                child: Image.network(
            ...
            Row(
              children: [
                  ...
                  child: BtnPrimary(
                      ...
                      cb_press: () async {
                        final DocumentReference reference = FirebaseFirestore
                            ...
                            .collection('BacSi')
                            .doc(widget.id);
                        await reference.update({'trangthai': true});
                ...
                Expanded(
                  child: BtnPrimary(
                    title: 'Từ chối',
                    cb_press: ()async {final DocumentReference reference = FirebaseFirestore
                            .instance
                            .collection('BacSi')
                            .doc(widget.id);
                        await reference.update({'trangthai': false});
                        const snackBar = SnackBar(
                          content: Text('bạn đã  từ chối duyệt bài đăng này'),
                        );
                        ScaffoldMessenger.of(context).showSnackBar(snackBar);
                        setState(() {});}
                    ,
