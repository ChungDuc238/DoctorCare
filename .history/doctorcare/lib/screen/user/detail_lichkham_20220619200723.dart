            ...
            child: Padding(
              ...
              child: Container(
                ...
                onPressed: () async {
                  ...
                  print(idLKUpdate);
                  await reference.update({'thoigian': time,'idDatLich':idLKUpdate});
                  final DocumentReference referenceLichKhamCurrent =
                      FirebaseFirestore.instance
                          .collection('lichkham')
                          .doc(idLK);
                  final DocumentReference referenceLichKhamUpdate =
                      FirebaseFirestore.instance
                          .collection('lichkham')
                          .doc(idLKUpdate);
                  await referenceLichKhamUpdate
                      .update({
                        'thoigian.$time': 'false',
                    'tenPhongKham': tenPK,
                    'ngay': date
                      });
                  await referenceLichKhamCurrent.update({
                    'thoigian.$timeCurrent': 'true'
