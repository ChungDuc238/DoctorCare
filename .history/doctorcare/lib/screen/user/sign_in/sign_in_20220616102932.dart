...
class _SignInWidgetState extends State<SignInWidget> {
                    ...
                    cb_press: () {
                      setState(() {
                        ...
                        _login(emailTextController.text,
                            passwordTextController.text, context, roleController.toString().split('.').last);
                      });
                    }),
                const SizedBox(
                  height: 10,
  ...
  void _login(String email, String password, BuildContext context, String role) async {
    ...
    final result = await authRepository.logInWithEmailAndPassword(
     ...
     Stream<QuerySnapshot> lichkham = FirebaseFirestore.instance
        .collection('lichkham')
...
Navigator.push(
          context, MaterialPageRoute(builder: (context) => HomeScreen(id: id!)));
    }
    else{
      // ignore: use_build_context_synchronously
      Navigator.push(
          context, MaterialPageRoute(builder: (context) =>  HomeDoctorScreen(id: id!,)));
    }
    }
      }
      // ignore: use_build_context_synchronously
