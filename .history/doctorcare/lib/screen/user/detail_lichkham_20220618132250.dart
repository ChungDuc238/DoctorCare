...
Stream<List<DatLichModel>> getDatLich(){
  return FirebaseFirestore.instance.collection('datlich').snapshots(). map((querySnap) => querySnap.docs).map((doc) => doc.data.id).toList();
}
