...
class _DoctorDetailsState extends State<DoctorDetails> {
  ...
  void initState() {
    super.initState();
    data = Doctor(id: id, email: email, password: password, avatar: avatar, benhvien: benhvien, cccd: cccd, chuyenmon: chuyenmon, diachi: diachi, gioitinh: gioitinh, khoa: khoa, mota: mota, ngaysinh: ngaysinh, sdt: sdt, sonamkinhnghiem: sonamkinhnghiem)
    getDoctor(widget.id);
  }
  @override
...
getDoctor(String id) async {
  final Doctor doctor = await getBS(id);
