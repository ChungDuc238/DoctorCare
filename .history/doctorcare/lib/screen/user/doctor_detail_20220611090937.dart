...
Stream<Doctor>  getBS(String id)  {
  final data1 =
       FirebaseFirestore.instance.collection('BacSi').doc(id).snapshots().map((DocumentSnapshot<Map<String, dynamic>> snapshot) => Doctor.fromJson(snapshot.data()!));
