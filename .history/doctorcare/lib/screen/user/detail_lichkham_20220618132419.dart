...
Future<List> getDatLich(){
  return FirebaseFirestore.instance.collection('datlich').snapshots().map((querySnap) => querySnap.docs //Mapping Stream of CollectionReference to List<QueryDocumentSnapshot>
