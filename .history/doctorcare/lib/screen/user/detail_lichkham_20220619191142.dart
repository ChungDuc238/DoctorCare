...
class _DetailLichKhamState extends State<DetailLichKham>
  ...
  Widget _getActionButtons() {
    final DocumentReference reference =
        FirebaseFirestore.instance.collection('datlich').doc(widget.idLichKham);
    return Padding(
              ...
              child: Container(
                ...
                onPressed: () {
                  ...
                  await  reference.update({'thoigian': time});
                    final DocumentReference referenceLichKham = await
                          FirebaseFirestore.instance
                              .collection('lichkham')
                              .doc(idLK);

                    await  referenceLichKham.update({'thoigian.$time': 'false'});
                     await  referenceLichKham.update({'thoigian.$timeCurrent': 'false'});
                  });
                },
              )),
            ),
