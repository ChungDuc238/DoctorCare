...
class _DoctorDetailsState extends State<DoctorDetails> {
  ...
  Widget build(BuildContext context) {
    final Doctor data = getBS(widget.id);
    return Scaffold(
      appBar: AppBar(
                ...
                child: Row(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network(
                        data.avatar??'https://png.pngtree.com/element_our/20190528/ourlarge/pngtree-handsome-doctor-image_1140314.jpg',
                        height: 80,
                        width: 80,
                      ),
                    ),
 ...
 getBS(String id) async{
  final data = await FirebaseFirestore.instance.collection('BacSi').doc(id).snapshots().map(
