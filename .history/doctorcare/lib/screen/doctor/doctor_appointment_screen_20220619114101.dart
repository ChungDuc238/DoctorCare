                  ...
                  onTap: () async {
                    ...
                    if (list.isEmpty) {
                      ...
                      for (int i = 0; i < list.length; i++) {
                        if (list.keys.elementAt(i) .compareTo(list.keys.elementAt(i+1)) == 0) {
                          tmp = 1;
                        }
                      }
                      if (tmp == 0) {
...
void putDataFirestore(
  ...
  final result = await FirebaseFirestore.instance.collection('lichkham').add(
      {'ngay': date, 'thoigian': list, 'tenphongkham': phongkham, 'id': id});
  print(result);
}
