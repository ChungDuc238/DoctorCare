...
import 'package:doctorcare/screen/doctor/widget/dropdown.dart';
...
void putDataFirestore(String date, List list, String phongkham, String id) async {
  final result = await FirebaseFirestore.instance
      .collection('demo')
      .add({'date': date, 'list': list, 'phongkham': phongkham,'id': id});
  print(result);
}
