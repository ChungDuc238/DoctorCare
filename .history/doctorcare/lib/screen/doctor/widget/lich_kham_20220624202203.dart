...
class _LichKhamBSState extends State<LichKhamBS> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: _updateLichKham(id ?? ''),
      bottomNavigationBar: const BottomNavigatorDoctor(currentIndex: 1),
    );
  }

  Widget _updateLichKham(String id) {
    final Stream<QuerySnapshot> lichkham = FirebaseFirestore.instance
        .collection('lichkham')
        .where('idBS', isEqualTo: id)
        .snapshots();
    setState(() {});
