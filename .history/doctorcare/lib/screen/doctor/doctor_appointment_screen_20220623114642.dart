            ...
            Row(
              children: [
                InkWell(
                  ...
                  onTap: () async {
                    int tmp = 0;
                    result = await caKham(startTime, endTime);
                    var time1 = result.split('-')[0];
                    var time2 = result.split('-')[1];
                    var hourStart = await convertStringToInt(time1);
                     var endStart = await convertStringToInt(time2);
                    print(hourStart.toString());
                    print(endStart.toString());
                    if (list.isEmpty) {
