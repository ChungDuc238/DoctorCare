    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          ...
          TopSnackBar(child: child, onDismissed: onDismissed, animationDuration: animationDuration, reverseAnimationDuration: reverseAnimationDuration, displayDuration: displayDuration, padding: padding, curve: curve, reverseCurve: reverseCurve)
          },
        ),
      ),
    );
