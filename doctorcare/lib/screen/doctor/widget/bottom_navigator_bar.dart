...
import 'package:doctorcare/screen/doctor/widget/lich_kham.dart';
import 'package:doctorcare/screen/doctor/widget/update_profile.dart';
      ...
      onTap: (index) {
        if (index == 0) {
          ...
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const LichKhamBS()));
        } else if (index == 2) {
          Navigator.of(context).push(
